...
html.H3("Dashboard COVID 19"),
html.P("Dashborad en construction sur l'évolution de la pandémie avec différents graphiques interactives sur l'évolution de la maladie"),
dcc.Link("Dashboard Covid-19", href="https://share.streamlit.io/sylvainballerini/covid/main/app.py", target="blank")
]
